  ...
  return (
    <section className="relative">
      ...
      {allDetails?.length && (
        <>
          <div>
            <div className="sm:my-1 flex sm:flex-row sm:items-end flex-col">
              <div className="my-1 sm:my-0 sm:basis-[55%] 2xl:basis-[55%] sm:h-[75vh] md:h-[85vh] xl:h-[115vh] 2xl:h-[125vh] h-[75vh] object-cover object-bottom">
                <motion.img
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
